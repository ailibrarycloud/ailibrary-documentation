...
AI Library API can be used to seamlessly add AI capabilities into any product. You can use [generate](#) to switch any model or create a [knowledge base](#) and add to it from a variety of [connections](#) to inject relevant information into your prompts. {{ className: 'lead' }}
