...
<Row>
  ...
  <Col sticky>
    <CodeGroup title="Request" tag="GET" label="/v1/form">

    ```python
    forms_response = client.forms.list_forms()
    ```
    </CodeGroup>
...
<Row>
  ...
  <Col sticky>
    <CodeGroup title="Request" tag="GET" label="/v1/form/{form_id}">
    ```python
    form_info = client.forms.get(form_id="my-form-id")
    ```
    </CodeGroup>
...
<Row>
  ...
  <Col sticky>
    ...
    response = client.forms.create(title="My Title", schema=schema)
    ```
    </CodeGroup>
...
<Row>
  ...
  <Col sticky>
    ...
    response = client.forms.update(title="New title", schema=new_schema)
    ```
    </CodeGroup>
    <CodeGroup title="Response">
...
<Row>
  ...
  <Col sticky>
    <CodeGroup title="Request" tag="DELETE" label="/v1/form/{form_id}">
    ```bash
    curl --location --request DELETE 'https://api.ailibrary.ai/v1/form/test-form_45160' \
    --header 'X-Library-Key: [[X-Library-Key-masked-secret]]'
    ```
    ```python
    response = client.forms.delete(form_id="my-form-id")
    ```
    </CodeGroup>
