...
<Row>
  <Col>
    ...
    This is a streaming API. Text responses are sent as they are generated.
    ...
    ### Response 
    Chat responses are streamed. Three types of objects are returned for each query.
  ...
  ```json {{'title': 'Body'}}
    ...
    for chunk in client.agent.chat_stream(namespace=name, messages=messages, session_id=session_id):
        print(chunk)
    ...
    ``` {{ title: 'Response' }}
    {"content": {"form_key1": "form_value1", ...}, "object": "chat.completion.form", "id": "niusjndckj23", ...}
    ...
    # Full String: Our pricing starts at $10/month for the basic plan.
    ```
    </Col>
</Row>
