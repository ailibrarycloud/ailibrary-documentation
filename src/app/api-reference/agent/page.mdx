...
<Row>
  <Col>
    ...
    This is not a streaming API. Responses are sent once everything has been generated. For a streaming version of this API, please see "Chat Stream".
    ...
    <Properties>
        ...
        <Property name="response_format" type="string">
            ...
            Note: Agent must have an attached form if using response_format="json"
        </Property>
...
## Chat Stream {{ tag: 'POST', label: '/v1/agent/{namespace}/chat' }}
<Row>
  <Col>
    Chat with the agent. 
    ...
    ### Response 
    Chat responses are streamed. There are four different types of objects; "chunk" and "latency" are returned for each query.
    {/* Three types of objects are returned for each query. */}

    |Object|Description|Type|
    |---|---|---|
    |chat.completion.form|this contains the form schema|dict|
  ...
  ```json {{'title': 'Body'}}
    ...
    session_id = "session_xyz789"  # Optional
    name = "sales-assistant-abc123"
    for json_object in client.agent.chat_stream(namespace=name, messages=messages, session_id=session_id):
    ...
    ```json {{ title: 'Response' }}
    {"content": "[0.94s]", "object": "chat.completion.latency", "id": "niusjndckj23"}
    {"content": "Our", "object": "chat.completion.chunk", "id": "niusjndckj23"}
    {"content": " pricing", "object": "chat.completion.chunk", "id": "niusjndckj23"}
    // ...
    {"content": " plan.", "object": "chat.completion.chunk", "id": "niusjndckj23"}
    // Full content string: [0.94s]Our pricing starts at $10/month for the basic plan.
    ```
    </Col>
</Row>
